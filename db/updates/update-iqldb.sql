CREATE TABLE `tblrunning` (
  ...
  `query` varchar(1000) COLLATE utf8mb4_bin NOT NULL COMMENT 'Query being performed (with large lists truncated)',
  `qhash` varchar(30) CHARACTER SET latin1 COLLATE latin1_bin NOT NULL COMMENT 'Hash of the query for duplicate detection',
  `username` varchar(100) COLLATE utf8mb4_bin NOT NULL COMMENT 'Username of the user executing the query',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='Queries currently running';
