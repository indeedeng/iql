...
public class MetricMetadataTest extends BasicTest {
    ...
    public void testDefaultDimension() throws Exception {
        ...
        testAll(expected, "from DIMension yesterday today SELECT timeofday, dayofweek, counts", options);
    }

    @Test
    public void testSelect() throws Exception {
        testAll(ImmutableList.of(ImmutableList.of("", "0", "5", "200", "10", "10", "1", "20", "70", "2", "3", "3")),
                ...
                options);
        testIQL2(ImmutableList.of(ImmutableList.of("", "59")), "from dimension yesterday today SELECT [i1*plus]", options);
        testIQL1(ImmutableList.of(ImmutableList.of("", "59")), "from DIMension yesterday today SELECT i1*plus", options);
        testIQL2(ImmutableList.of(ImmutableList.of("", "200")), "from dimension yesterday today SELECT i1*plus", options);
        testIQL2(ImmutableList.of(ImmutableList.of("", "4", "1")), "from dimension yesterday today SELECT plus!=i1, plus=calc", options);
        testIQL2(ImmutableList.of(ImmutableList.of("", "2")), "from dimension yesterday today SELECT LUCENE('i1:0')", options);
        testIQL2(ImmutableList.of(ImmutableList.of("", "2")), "from dimension yesterday today SELECT LUCENE('aliasi1:0')", options);
        testIQL2(ImmutableList.of(ImmutableList.of("", "1", "2.67", "4.86", "0.89", "13", "13")), "from dimension yesterday today SELECT " +
    ...
    public void testSelectMultiple() throws Exception {
        testIQL2(ImmutableList.of(ImmutableList.of("", "200", "100", "300", "1", "2", "2", "2", "2")),
    ...
    public void testAggregateDimension() throws Exception {
        testIQL2(ImmutableList.of(ImmutableList.of("", "11", "100")), "from dimension yesterday today SELECT i1+i1divi2, aliasi1*10", options);
    ...
    public void testDimensionAliasFieldRewrite() throws Exception {
        testIQL2(ImmutableList.of(ImmutableList.of("", "10")), "from dimension yesterday today SELECT si1", options);
    }
    ...
    public void testGroupBy() throws Exception {
        {
            ...
            testIQL2(expected, "from dimension yesterday today GROUP BY aliasi1[HAVING plus > 3], i2 HAVING counts > 0 SELECT counts", options);
        }
        {
            final List<List<String>> expected = new ArrayList<>();
            ...
            testIQL2(expected, "from dimension yesterday today GROUP BY bucket(plus, 0, 6, 2)", options);
        }
        testIQL2(ImmutableList.of(ImmutableList.of("1", "1")), "from dimension yesterday today GROUP BY i2 HAVING i1divi2 > 1", options);
        testIQL2(ImmutableList.of(ImmutableList.of("0", "2"), ImmutableList.of("2", "2")), "from dimension yesterday today, dimension2 GROUP BY i2 HAVING count() > 1", options);
    ...
    public void testFilter() throws Exception {
        testAll(ImmutableList.of(ImmutableList.of("", "2")), "from DIMension yesterday today WHERE aliasi1=0 SELECT counts", options);
        testAll(ImmutableList.of(ImmutableList.of("", "1")), "from DIMension yesterday today WHERE aliasi1=0 AND i2 = 0 SELECT counts", options);
        testAll(ImmutableList.of(ImmutableList.of("", "2")), "from DIMension yesterday today WHERE plus=5 SELECT counts", options);
        testAll(ImmutableList.of(ImmutableList.of("", "3")), "from DIMension yesterday today WHERE plus!=5 SELECT counts", options);
        // 'between(...)' is different in Iql1 (upper bound is included) and Iql2 (upper is excluded), so two tests here.
        testIQL1(ImmutableList.of(ImmutableList.of("", "4")), "from DIMension yesterday today where between(plus, 0, 5) SELECT counts", options);
        testIQL2(ImmutableList.of(ImmutableList.of("", "2")), "from DIMension yesterday today where between(plus, 0, 5) SELECT counts", options);
        testIQL2(ImmutableList.of(ImmutableList.of("", "1")), "from dimension yesterday today WHERE i1=plus SELECT counts", options);
        testIQL2(ImmutableList.of(ImmutableList.of("", "1")), "from dimension yesterday today WHERE plus=calc SELECT counts", options);
    ...
    public void testFilterMultiple() throws Exception {
        testIQL2(ImmutableList.of(ImmutableList.of("", "1")), "from dimension yesterday today as d1, dimension2 as d2 WHERE i2 = 4 AND i1 = 4", options);
        testIQL2(ImmutableList.of(ImmutableList.of("", "2")), "from dimension yesterday today as d1, dimension2 as d2 WHERE calc = 0", options);
        testIQL2(ImmutableList.of(ImmutableList.of("", "3")), "from dimension yesterday today as d1, dimension2 as d2 WHERE d1.plus = 0", options);
        testIQL2(ImmutableList.of(ImmutableList.of("", "1")), "from dimension 2015-01-01 2015-01-02 as d1, dimension 2015-01-02 2015-01-03 as d2 WHERE plus = 0", options);
    ...
    public void testDatasetAlias() throws Exception {
        // testIQL2(ImmutableList.of(ImmutableList.of("", "5")),
        ...
        testIQL2(ImmutableList.of(ImmutableList.of("", "5")),
                ...
                options);
        testIQL2(ImmutableList.of(ImmutableList.of("", "10", "10", "210")),
