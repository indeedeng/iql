...
public class GroupByHavingTest extends BasicTest {
    ...
    public void testHaving() throws Exception {
        testIQL2(GroupByHavingDataset.createDataset(), ImmutableList.<List<String>>of(ImmutableList.of("0", "3")), "FROM test yesterday today GROUP BY label HAVING val > 2", true);
    }
    ...
    public void testHavingDivide() throws Exception {
        ...
        testIQL2(GroupByHavingDataset.createDataset(), expected, "FROM test yesterday today " +
