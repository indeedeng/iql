...
public class AggregateMetricsTest extends BasicTest {
    ...
    public void testModulus() throws Exception {
        ...
        QueryServletTestUtils.testIQL2(expected, "from organic yesterday today select 3 % 2, 2 % 2, 100 % 2, count() % 2");
    }
    ...
    public void testPower() throws Exception {
        ...
        QueryServletTestUtils.testIQL2(expected, "from organic yesterday today select 3 ^ 2, 3 ^ 3, 2 ^ 0.5, count() ^ 2, count() ^ 0.5");
    }
    ...
    public void testIfThenElse() throws Exception {
        ...
        QueryServletTestUtils.testIQL2(expected, "from organic yesterday today select if count() > 0 then 100 else 0, if count() <= 0 then 100 else 0");
    }
    ...
    public void testNamed() throws Exception {
        ...
        QueryServletTestUtils.testIQL2(expected, "from organic yesterday today select count() as c, c + 5, c * c");
    }
    ...
    public void testLag() throws Exception {
        ...
        QueryServletTestUtils.testIQL2(expected, "from organic yesterday today group by time(1h) select count(), lag(1, count()), lag(2, count())");
    }
    ...
    public void testIterateLag() throws Exception {
        ...
        QueryServletTestUtils.testIQL2(expected, "from organic yesterday today group by tk select count(), lag(1, count()), lag(2, count())");
        QueryServletTestUtils.testIQL2(expected,
    ...
    public void testWindow() throws Exception {
        ...
        QueryServletTestUtils.testIQL2(expected, "from organic yesterday today group by time(1h) select count(), window(2, count()), window(5, count())");
    }
    ...
    public void testRunning() throws Exception {
        ...
        QueryServletTestUtils.testIQL2(expected, "from organic yesterday today group by time(1h) select count(), running(count())");
    }
    ...
    public void testPercentile1() throws Exception {
        ...
        QueryServletTestUtils.testIQL2(expected, "from organic yesterday today select percentile(allbit, 0.00001), percentile(allbit, 50), percentile(allbit, 100)", true);
    }

    @Test
    public void testMedian() throws Exception {
        QueryServletTestUtils.testIQL2(ImmutableList.of(ImmutableList.of("","1")), "from organic yesterday today select median(allbit)", true);
        QueryServletTestUtils.testIQL2(ImmutableList.of(ImmutableList.of("","10")), "from organic 2015-01-01 00:00:00  2015-01-01 01:00:00 select median(oji)", true);
        QueryServletTestUtils.testIQL2(ImmutableList.of(ImmutableList.of("","13")), "from organic 2015-01-01 03:00:00 2015-01-02 00:00:00 select median(oji)", true);
        QueryServletTestUtils.testIQL2(ImmutableList.of(ImmutableList.of("","1")), "from organic 2015-01-01 03:00:00 2015-01-02 00:00:00 select median(ojc)", true);
    }
    ...
    public void sumAcross() throws Exception {
        ...
        QueryServletTestUtils.testIQL2(expected, "from organic yesterday today select sum_over(tk, count()), sum_over(tk, 1), sum_over(tk, [2])");
        QueryServletTestUtils.testIQL2(ImmutableList.of(ImmutableList.of("", "306", "2653", "151")),
    ...
    public void testRegroupIntoParent() throws Exception {
        final List<List<String>> expected = new ArrayList<>();
        expected.add(ImmutableList.of("1", "151", "151", "151"));
        // SUM_OVER and RUNNING in one query cause RegroupIntoParent command to happen.
        QueryServletTestUtils.testIQL2(expected, "FROM organic yesterday today group by (true) HAVING COUNT()>0 SELECT count(), SUM_OVER(time(1d), COUNT()), RUNNING(COUNT())");
    }
    ...
    public void testAVG() throws  Exception {
        ...
        QueryServletTestUtils.testIQL2(expected, "from organic 2015-01-01 00:00 2015-01-01 01:00 SELECT AVG(oji), AVG(DISTINCT(tk))");
    }
