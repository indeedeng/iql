...
public class GroupByTest {
    ...
    public void groupByMetric() throws Exception {
        final GroupByEntry bucketOji1to10by1 = new GroupByEntry(new GroupBy.GroupByMetric(new DocMetric.Field("OJI"), 1, 10, 1, false, false), Optional.<AggregateFilter>absent(), Optional.<String>absent());
        ...
        final GroupByEntry bucketOji1to10by2NoGutter = new GroupByEntry(new GroupBy.GroupByMetric(new DocMetric.Field("OJI"), 1, 10, 2, true, false), Optional.<AggregateFilter>absent(), Optional.<String>absent());
        ...
        final GroupByEntry withNegatives = new GroupByEntry(new GroupBy.GroupByMetric(new DocMetric.Field("OJI"), -10, 10, 1, false, false), Optional.<AggregateFilter>absent(), Optional.<String>absent());
        ...
        final GroupByEntry withDefault = new GroupByEntry(new GroupBy.GroupByMetric(new DocMetric.Field("OJI"), -10, 10, 1, true, true), Optional.<AggregateFilter>absent(), Optional.<String>absent());
