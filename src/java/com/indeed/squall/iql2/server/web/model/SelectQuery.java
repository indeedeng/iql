...
public class SelectQuery implements Closeable {
    ...
    public static final byte VERSION_FOR_HASHING = 12;
    ...
    final SelectQueryExecution selectQueryExecution;
    boolean cancelled = false;
    public DateTime queryStartTimestamp;
    ...
    public SelectQuery(RunningQueriesManager runningQueriesManager, String queryString, ClientInfo clientInfo, Limits limits, DateTime querySubmitTimestamp, byte sessions, final SelectQueryExecution selectQueryExecution) {
        ...
        this.selectQueryExecution = selectQueryExecution;
    ...
    public String toString() {
        return "SelectQuery{" +
                ...
                ", selectQueryExecution=" + selectQueryExecution +
                ", sessions=" + sessions +
