...
public class IQLTempFiles extends AbstractTempFiles<IQLTempFiles.Type> {
    ...
    public TempFile createForIQL1(final String queryHash) throws IOException {
        return createTempFile(Type.IQL1_QUERY_CACHE, queryHash);
    }

    public TempFile createForIQL2(final String queryHash) throws IOException {
        return createTempFile(Type.IQL2_QUERY_CACHE, queryHash);
    }
