...
public class ExtractSamples {
    ...
    public static QueryResult extractSamples(Query query) {
        if (query.filter.isPresent()) {
            ...
            final Query newQuery = new Query(query.datasets, Optional.of(result.sampleFree), query.groupBys, query.selects, query.formatStrings, query.options, query.rowLimit, query.useLegacy);
