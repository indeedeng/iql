...
public class StatementParser {
    private static final Pattern selectPattern = Pattern.compile("\\s*(?:select|from) .*", Pattern.CASE_INSENSITIVE);
    private static final Pattern explainPattern = Pattern.compile("\\s*explain\\s+(.*)", Pattern.CASE_INSENSITIVE);
