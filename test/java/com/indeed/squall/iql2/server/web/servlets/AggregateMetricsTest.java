...
public class AggregateMetricsTest extends BasicTest {
    ...
    public void testAVG() throws  Exception {
        final List<List<String>> expected = new ArrayList<>();
        expected.add(ImmutableList.of("", "118"));
        final List<Shard> shards = OrganicDataset.create();
        QueryServletTestUtils.testIQL2(shards, expected, "from organic 2015-01-01 00:00 2015-01-01 01:00 SELECT avg(oji)");
    }

    @Test
    public void testMultiAVG() throws  Exception {
        final List<List<String>> expected = new ArrayList<>();
        expected.add(ImmutableList.of("", "118", "10", "25.43", "25.43"));
        final List<Shard> shards = OrganicDataset.create();
        QueryServletTestUtils.testIQL2(shards, expected,
                "from organic 2015-01-01 00:00 2015-01-01 01:00 as o1, organic 2015-01-01 01:00 2015-01-01 02:00 as o2 " +
                        "SELECT AVG(o1.oji), AVG(o2.oji), PRINTF('%.2f', AVG(oji)), PRINTF('%.2f', AVG(o1.oji+o2.oji))");
    }
}
