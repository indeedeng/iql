...
public class FieldEqualFilterTest extends BasicTest {
    ...
    public void testMultiDatasetEqualFieldFilter() throws Exception {
        try {
            testIQL2(FieldEqualDataset.create(), ImmutableList.<List<String>>of(ImmutableList.of("", "fail")), "from organic yesterday today as o1, organic yesterday today as o2 where o1.i1 = o2.i2");
