...
public class DimensionTest extends BasicTest {
    ...
    private final List<Shard> dataset = DimensionUtils.createDataset();
    ...
    public void testSelect() throws Exception {
        ...
        testAll(dataset, expected,
                ...
                imsClient);
        testIQL2(dataset, ImmutableList.of(ImmutableList.of("", "59")), "from dimension yesterday today SELECT [i1*plus]", imsClient);
        testIQL1(dataset, ImmutableList.of(ImmutableList.of("", "59")), "from dimension yesterday today SELECT i1*plus", imsClient);
        testIQL2(dataset, ImmutableList.of(ImmutableList.of("", "200")), "from dimension yesterday today SELECT i1*plus", imsClient);
        testIQL2(dataset, ImmutableList.of(ImmutableList.of("", "4", "1")), "from dimension yesterday today SELECT plus!=i1, plus=calc", imsClient);
        testIQL2(dataset, ImmutableList.of(ImmutableList.of("", "2")), "from dimension yesterday today SELECT LUCENE('i1:0')", imsClient);
    ...
    public void testAggregateDimension() throws Exception {
        testIQL2(dataset, ImmutableList.of(ImmutableList.of("", "11", "100")), "from dimension yesterday today SELECT i1+i1divi2, aliasi1*10", imsClient);
    ...
    public void testGroupBy() throws Exception {
        {
            ...
            testIQL2(dataset, expected, "from dimension yesterday today GROUP BY aliasi1[HAVING plus > 3], i2 HAVING counts > 0 SELECT counts", imsClient);
        }
        {
            final List<List<String>> expected = new ArrayList<>();
            ...
            testIQL2(dataset, expected, "from dimension yesterday today GROUP BY bucket(plus, 0, 5, 2)", imsClient);
        }
        testIQL2(dataset, ImmutableList.of(ImmutableList.of("1", "1")), "from dimension yesterday today GROUP BY i2 HAVING i1divi2 > 1", imsClient);
        testIQL2(dataset, ImmutableList.of(ImmutableList.of("0", "2"), ImmutableList.of("2", "2")), "from dimension yesterday today, dimension2 GROUP BY i2 HAVING counts > 1", imsClient);
    ...
    public void testFilter() throws Exception {
        testAll(dataset, ImmutableList.of(ImmutableList.of("", "2")), "from dimension yesterday today WHERE aliasi1=0 SELECT counts", imsClient);
        testAll(dataset, ImmutableList.of(ImmutableList.of("", "1")), "from dimension yesterday today WHERE aliasi1=0 AND i2 = 0 SELECT counts", imsClient);
        testAll(dataset, ImmutableList.of(ImmutableList.of("", "2")), "from dimension yesterday today WHERE plus=5 SELECT counts", imsClient);
        testAll(dataset, ImmutableList.of(ImmutableList.of("", "3")), "from dimension yesterday today WHERE plus!=5 SELECT counts", imsClient);
        testAll(dataset, ImmutableList.of(ImmutableList.of("", "2")), "from dimension yesterday today WHERE BETWEEN(plus, 0, 5) SELECT counts", imsClient);
        testIQL2(dataset, ImmutableList.of(ImmutableList.of("", "1")), "from dimension yesterday today WHERE i1=plus SELECT counts", imsClient);
        testIQL2(dataset, ImmutableList.of(ImmutableList.of("", "1")), "from dimension yesterday today WHERE plus=calc SELECT counts", imsClient);
        assertFailQuery("from dimension yesterday today WHERE i1divi2=1");
    }

    @Test
    public void testFilterMultiple() throws Exception {
        testIQL2(dataset, ImmutableList.of(ImmutableList.of("", "1")), "from dimension yesterday today as d1, dimension2 as d2 WHERE i2 = 4 AND i1 = 4", imsClient);
        testIQL2(dataset, ImmutableList.of(ImmutableList.of("", "2")), "from dimension yesterday today as d1, dimension2 as d2 WHERE calc = 0", imsClient);
    ...
    private void assertIQL1FailQuery(final String query) throws Exception {
        try {
            testIQL1(dataset, ImmutableList.of(ImmutableList.of()), query, imsClient);
    ...
    private void assertIQL2FailQuery(final String query) throws Exception {
        try {
            testIQL2(dataset, ImmutableList.of(ImmutableList.of()), query, imsClient);
            Assert.fail(query + " is expected to fail");
        } catch (IllegalArgumentException ex) {}
