...
public class DimensionTest extends BasicTest {
    ...
    public void testSelect() throws Exception {
        ...
        testIQL2(dataset, ImmutableList.of(ImmutableList.of("", "2.67", "0.89", "13")), "from dimension yesterday today SELECT " +
                "PRINTF('%.2f', SUM_OVER(s1, i1divi2)), PRINTF('%.2f', AVG_OVER(s1, i1divi2)), AVG_OVER(s1 HAVING plus > 5, plus)", options);
